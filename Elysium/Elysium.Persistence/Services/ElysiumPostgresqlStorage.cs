...
{
    public class ElysiumPostgresqlStorage : IElysiumStorage
    {
        private readonly ElysiumPostgresqlStorageSettings _settings;
        private readonly JsonSerializerSettings _serializerSettings;
        private readonly string _connectionString;
        private readonly string _primaryTableName;
        private readonly string _foreignKeyTableName;

        public ElysiumPostgresqlStorage(IOptions<ElysiumPersistenceSettings> options)
        {
            _settings = options.Value.PostgresqlStorageSettings ?? throw new ArgumentNullException(nameof(ElysiumPersistenceSettings.PostgresqlStorageSettings));
